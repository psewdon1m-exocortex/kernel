...
Текущий coordinated baseline требует Updater `0.4.3` или новее; Kernel 0.2.10 закрепляет `0.4.3` как проверенную release dependency. Репозиторий сервиса хранит точную версию в `.release/updater.version`.
